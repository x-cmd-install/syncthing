...
[![x-cmd/install — syncthing Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/syncthing.svg?lang=zh)](https://x-cmd.com/install/syncthing)
...
合计: **181,231** 行代码（覆盖前 5 种语言、共 **671** 个文件）。
...
- **上游仓库**: <https://github.com/syncthing/syncthing>
- **官网**: <https://syncthing.net/>
- **许可证**: MPL-2.0

## 发布

- **最新版本**: `v2.1.6-rc.3` (2026-09-08)
- **最近提交**: 2026-09-22
- **Release 含资产**: 35 个

## 流行度

- **Star**: 88,936 · **Fork**: 5,492 · **开放 issue**: 5,964 · **贡献者**: 356

## 累计统计

- **发布数**: 483 · **已合并 PR**: 2933 · **开放 PR**: 16 · **已关闭 issue**: 5597 · **开放 issue**: 367 · **提交数**: 8199

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-27 | 3 | 5 | 0 | 12 | 7 | 10 |
| last60d | 2026-07-28 | 8 | 13 | 1 | 23 | 17 | 27 |
| 90d | 2026-06-28 | 10 | 37 | 5 | 42 | 20 | 58 |
| last180d | 2026-03-30 | 20 | 89 | 8 | 84 | 29 | 151 |
| 360d | 2025-10-01 | 33 | 130 | 10 | 178 | 57 | 229 |
| last720d | 2024-10-06 | 98 | 370 | 15 | 409 | 92 | 663 |
...
syncthing 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `syncthing` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/syncthing.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260926.yml` · 2026-09-26T05:08:04Z._
