...
合计: **181,121** 行代码（覆盖前 5 种语言、共 **669** 个文件）。
...
- **Star**: 88,505 · **Fork**: 5,466 · **开放 issue**: 5,953 · **贡献者**: 356

## 累计统计

- **发布数**: 481 · **已合并 PR**: 2929 · **开放 PR**: 17 · **已关闭 issue**: 5590 · **开放 issue**: 363 · **提交数**: 8194
...
在 [repology.org](https://repology.org/project/syncthing) 上共有 **208** 个发行版报告此项目。**38** 个 ✅ 已是最新上游版本，**147** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260913.yml` · 2026-09-13T05:11:56Z._
